...
const {updateMapMetadata, deleteMap, createThumbnail} = require('../../../MapStore2/web/client/actions/maps');
const MapGrid = connect(() => ({}), {updateMapMetadata, deleteMap, createThumbnail})(require('../../../MapStore2/web/client/components/maps/MapGrid'));
